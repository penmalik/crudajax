...
<body>
    ...
    <nav class="navbar justify-content-center fs-3 mb-3" style="background-color: #00ff5573;">AJAX CRUD</nav>
            ...
            <form method="post" id="insertForm">
                <div class="row mb-3">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="first_name" placeholder="Burna">
                    </div>
                    <div class="col">
                        <label class="form-label">Last name</label>
                        <input type="text" class="form-control" name="last_name" placeholder="Boy">
                    </div>
                </div>
                <div class="mb-3">
